# Email Cron Heartbeat & Recovery ΓÇö Atomic Feature Specification
...
4. If **new emails found**:
   a. Run spam pre-filter (rule-based, see `email-management.md` ┬º8).
...
- **Queue:** Heartbeat jobs use the standard task queue with status lifecycle: `PENDING ΓåÆ RUNNING ΓåÆ COMPLETED / FAILED / INTERRUPTED`.
