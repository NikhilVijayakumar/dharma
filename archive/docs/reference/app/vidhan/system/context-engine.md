...
**Runtime provider configuration (priority)** ΓÇö can include optional user-supplied context window:

- `ModelProviderConfig.contextWindow` ΓÇö user-configured context window in tokens
- `ModelProviderConfig.reservedOutputTokens` ΓÇö user-configured reserved output in tokens
