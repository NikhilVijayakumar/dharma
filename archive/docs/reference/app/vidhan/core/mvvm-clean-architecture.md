...
src/renderer/src/
Γö£ΓöÇΓöÇ features/
Γöé   ΓööΓöÇΓöÇ [feature_name]/        # e.g., users
Γöé       Γö£ΓöÇΓöÇ view/              # UI Components (Pure MUI)
Γöé       Γöé   Γö£ΓöÇΓöÇ [Feature]Container.tsx
Γöé       Γöé   ΓööΓöÇΓöÇ [Feature]List.tsx
Γöé       Γö£ΓöÇΓöÇ viewmodel/         # Business Logic
Γöé       Γöé   ΓööΓöÇΓöÇ use[Feature]ViewModel.ts
Γöé       ΓööΓöÇΓöÇ repo/              # Data Layer
Γöé           ΓööΓöÇΓöÇ [Feature]Repo.ts
ΓööΓöÇΓöÇ layout/                    # App Shell (MainLayout)
```
