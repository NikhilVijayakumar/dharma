---
id: cross-module-cohesion
title: Cross-Module Cohesion
tags: [orchestration, systems]
---
# Cross-Module Cohesion

## Purpose
Coordinates dependencies across modules to prevent conflicting priorities, duplicated effort, and execution deadlocks.

## Activation Triggers
- Trigger when tasks match the Cross-Module Cohesion responsibility domain.
