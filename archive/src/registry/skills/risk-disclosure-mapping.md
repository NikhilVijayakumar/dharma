---
id: risk-disclosure-mapping
title: Risk Disclosure Mapping
tags: [generated, agentic]
---
# Risk Disclosure Mapping

## Purpose
Defines specialized capability for Risk Disclosure Mapping workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Risk Disclosure Mapping responsibility domain.
