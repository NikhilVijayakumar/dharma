---
id: bottleneck-diagnostic-logic
title: Bottleneck Diagnostic Logic
tags: [generated, agentic]
---
# Bottleneck Diagnostic Logic

## Purpose
Defines specialized capability for Bottleneck Diagnostic Logic workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Bottleneck Diagnostic Logic responsibility domain.
