---
id: organizational-design-strategy
...
## Purpose
Defines specialized capability for Organizational Design Strategy workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Organizational Design Strategy responsibility domain.
