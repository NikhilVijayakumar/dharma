---
id: self-healing-ui-correction
title: Self Healing Ui Correction
tags: [generated, agentic]
---
# Self Healing Ui Correction

## Purpose
Defines specialized capability for Self Healing Ui Correction workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Self Healing Ui Correction responsibility domain.
