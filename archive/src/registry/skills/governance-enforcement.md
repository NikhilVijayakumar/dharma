...
## Purpose
Implements practical policy gates that maintain regulatory defensibility while minimizing operational friction.

## Activation Triggers
- Trigger when tasks match the Governance Enforcement responsibility domain.
