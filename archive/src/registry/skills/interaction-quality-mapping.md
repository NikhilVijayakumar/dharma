---
id: interaction-quality-mapping
title: Interaction Quality Mapping
tags: [design, ux]
---
# Interaction Quality Mapping

## Purpose
Maps user journeys to friction points and interaction failures, then prioritizes improvements by outcome significance.

## Activation Triggers
- Trigger when tasks match the Interaction Quality Mapping responsibility domain.
