...
## Purpose
Defines specialized capability for Drift Detection Logic workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Drift Detection Logic responsibility domain.
