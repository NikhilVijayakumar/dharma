---
id: handoff-integrity-audit
title: Handoff Integrity Audit
tags: [generated, agentic]
---
# Handoff Integrity Audit

## Purpose
Defines specialized capability for Handoff Integrity Audit workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Handoff Integrity Audit responsibility domain.
