---
id: clean-architecture-enforcement
...
## Purpose
Applies architecture boundaries and dependency controls to keep codebases maintainable, testable, and resilient under growth.

## Activation Triggers
- Trigger when tasks match the Clean Architecture Enforcement responsibility domain.
