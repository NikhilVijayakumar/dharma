---
id: latency-optimization-strategy
...
## Purpose
Defines specialized capability for Latency Optimization Strategy workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Latency Optimization Strategy responsibility domain.
