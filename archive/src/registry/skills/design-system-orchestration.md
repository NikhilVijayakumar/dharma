---
id: design-system-orchestration
...
## Purpose
Defines specialized capability for Design System Orchestration workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Design System Orchestration responsibility domain.
