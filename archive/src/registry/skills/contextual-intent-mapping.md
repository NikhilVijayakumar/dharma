---
id: contextual-intent-mapping
title: Contextual Intent Mapping
tags: [generated, agentic]
---
# Contextual Intent Mapping

## Purpose
Defines specialized capability for Contextual Intent Mapping workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Contextual Intent Mapping responsibility domain.
