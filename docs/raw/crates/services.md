...
- Domain/Agent System resolution (Default/Bootstrap Agent System logic)
...
- The operations both `cli` and `mcp` call — repository registration, Task assignment, proposal submission/approval, handoff
