---
id: behavioral-alignment-audit
title: Behavioral Alignment Audit
tags: [generated, agentic]
---
# Behavioral Alignment Audit

## Purpose
Defines specialized capability for Behavioral Alignment Audit workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Behavioral Alignment Audit responsibility domain.
...
- deep_persona_fields: personality_traits, interaction_style, constraints.
- stage_binding: stage_plan and stage_synthesis outputs must preserve persona constraints.
- model_policy_hooks: include model_fallback_chain and cooldown hints in recommendations when provider instability is detected.
- workflow_binding: attach global protocol references used to validate behavioral alignment decisions.
