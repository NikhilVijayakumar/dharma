...
## Purpose
Ensures command handoffs preserve intent, dependencies, and trace context so downstream execution remains deterministic.

## Activation Triggers
- Trigger when tasks match the Handoff Integrity responsibility domain.
