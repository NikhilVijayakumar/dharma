...
## Purpose
Builds constrained resource plans that optimize spend against milestone confidence, downside protection, and runway health.

## Activation Triggers
- Trigger when tasks match the Budget Allocation responsibility domain.
