---
id: schema-design-and-migration
...
## Purpose
Defines specialized capability for Schema Design And Migration workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Schema Design And Migration responsibility domain.
