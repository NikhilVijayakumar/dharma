...
## Purpose
Diagnoses systemic defects using trace evidence, historical diffs, and failure patterns to identify durable remediation paths.

## Activation Triggers
- Trigger when tasks match the Code Forensics responsibility domain.
