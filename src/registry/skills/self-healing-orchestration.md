...
## Purpose
Defines specialized capability for Self Healing Orchestration workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Self Healing Orchestration responsibility domain.
