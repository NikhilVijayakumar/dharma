---
id: investor-pipeline-prioritization
title: Investor Pipeline Prioritization
tags: [funding, strategy]
---
# Investor Pipeline Prioritization

## Purpose
Ranks investor opportunities using stage probability, strategic fit, and follow-up quality to improve capital outcomes.

## Activation Triggers
- Trigger when tasks match the Investor Pipeline Prioritization responsibility domain.
