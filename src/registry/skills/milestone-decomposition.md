...
## Purpose
Defines specialized capability for Milestone Decomposition workflows and decisions.

## Activation Triggers
- Trigger when tasks match the Milestone Decomposition responsibility domain.
