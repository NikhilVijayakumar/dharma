...
## Purpose
Evaluates interface coherence, readability, and trust signals to identify design debt with business impact.

## Activation Triggers
- Trigger when tasks match the Visual Audit responsibility domain.
