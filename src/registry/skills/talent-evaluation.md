...
## Purpose
Applies competency and context-fit scoring frameworks to increase hiring signal quality and reduce role mismatch.

## Activation Triggers
- Trigger when tasks match the Talent Evaluation responsibility domain.
