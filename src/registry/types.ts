...
export interface RegistryProductDefinition {
  goal: string
  vision: string
...
export interface RegistryCompanyRegistry {
  companyId: string
  metadata: string
  products: Record<string, RegistryProductDefinition>
...
export interface RegistryProductAssignment {
  productId: string
  assignedAt?: string
  owner?: {
    agentId?: string
...
export interface RegistryProductAssignments {
  companyId: string
  companyName?: string
